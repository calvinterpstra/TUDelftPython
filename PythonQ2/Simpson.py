# -*- coding: utf-8 -*-
"""
Simpson.py  -- numerical integration using Simpson's rule.
...
def doMain():
    ...
    hpIntgrl = sp.integrate.simps(y=S[:,1],x=S[:,0],dx=1)
    ...
    for fr in fractions:
        ...
        valIntgrl = sp.integrate.simps(y=data[:,1],x=data[:,0],dx=1)
    ...
    fig.savefig('simpson.jpg', dpi=600)
