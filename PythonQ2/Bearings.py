...
# ==========
    ...
    # constanten voor initiele waarden CRMIN en CRMAX ...
	 # gebruik de grenzen van het open domein ... welke wijs je toe
    # aan CRMIN en welke aan CRMAX ?
    ...
    crmin,crmax,crsum = (CRMIN,CRMAX,0)
    # welke Nr horen bij deze waarden tot nu toe?
    ...
    cravg = crsum/len(data)        # deel door aantal lager voor average
...
# ==========
    ...
    # ... het eigenlijke histogram van de Cr waarden ...
    # Wat moet hier worden afgedrukt ?
    axis.hist(data[...,MAX], 
